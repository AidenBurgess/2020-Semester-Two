...
class A2Fuse2(LoggingMixIn):
    def __init__(self, source1, source2):
        self.real1 = Passthrough(source1)
        self.real2 = Passthrough(source2)
        self.mem = Memory()
    ...
    def all_src(self, func, *args):
        for src in [self.real1, self.real2, self.mem]:
            try:
    ...
    def readdir(self, *args):
        return chain(self.real1.readdir(*args), self.real2.readdir(*args), self.mem.readdir(*args))
